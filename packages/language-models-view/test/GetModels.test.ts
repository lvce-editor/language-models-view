...
test('getModels should return specific models', async () => {
  ...
  expect(models).toEqual([
    ...
    { enabled: true, id: 'llama-2-70b', inputContextSize: 4096, name: 'Llama 2 70B', outputContextSize: 2048, provider: 'meta', selected: false },
    { enabled: true, id: 'llama-3', inputContextSize: 8192, name: 'Llama 3', outputContextSize: 4096, provider: 'meta', selected: false },
    ...
    { enabled: false, id: 'palm-2', inputContextSize: 8192, name: 'PaLM 2', outputContextSize: 1024, provider: 'google', selected: false },
    {
      enabled: true,
      id: 'codellama-34b',
    ...
    { enabled: false, id: 'falcon-180b', inputContextSize: 2048, name: 'Falcon 180B', outputContextSize: 2048, provider: 'tii', selected: false },
    {
      enabled: true,
      id: 'mixtral-8x7b',
      inputContextSize: 32_768,
